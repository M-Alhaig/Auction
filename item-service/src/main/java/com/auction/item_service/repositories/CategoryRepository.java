...
public interface CategoryRepository extends JpaRepository<Category, Integer> {
     ...
     * Used when looking up categories by name instead of ID.
     *
    ...
    /**
     * Find all categories matching the given set of IDs.
     * Used when creating/updating items with multiple categories.
     * Returns a Set to match the Item entity's category relationship type.
     *
     ...
     * Used for validation before creating new categories to prevent duplicates.
