...
public interface EventPublisher {
   ...
   *
   * <p>RabbitMQ Implementation: - Routes to exchange based on event class name - Uses topic exchange
   * with routing key pattern: {service}.{event-type}
   *
   * <p>SQS/SNS Implementation: - Publishes to SNS topic based on event class name - Subscribers (SQS
