 ...
 *
 * Consumers:
 * - Item Service: Updates currentPrice for the item
...
public record BidPlacedEvent(
     ...
     */
    public static BidPlacedEvent create(Long itemId, UUID bidderId, BigDecimal bidAmount, LocalDateTime bidTimestamp) {
