 ...
 *
 * <p>Consumers: - Item Service: Updates currentPrice for the item - Notification Service: Pushes
 * real-time updates to WebSocket clients
 *
 * <p>Event Envelope Pattern: - eventId: Unique identifier for idempotency (prevents duplicate
